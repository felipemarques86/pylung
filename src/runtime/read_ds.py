...
def populate_data(normalization_func, xtrain, xtrain_1, ytrain, ytrain_1, xtest, xtest_1, ytest, ytest_1):
...
def read_lidc_dataset(normalization_func=lambda x: x):
    ...
    x_train, y_train, x_test, y_test = populate_data(normalization_func, x_train, x_train_1, y_train, y_train_1, x_test, x_test_1,
                                                     y_test, y_test_1)
    ...
    x_train, y_train, x_test, y_test = populate_data(normalization_func, x_train, x_train_2, y_train, y_train_2, x_test, x_test_2,
                                                     y_test, y_test_2)
    ...
    x_train, y_train, x_test, y_test = populate_data(normalization_func, x_train, x_train_3, y_train, y_train_3, x_test, x_test_3,
                                                     y_test, y_test_3)
    ...
    x_train, y_train, x_test, y_test = populate_data(normalization_func, x_train, x_train_4, y_train, y_train_4, x_test, x_test_4,
                                                     y_test, y_test_4)
